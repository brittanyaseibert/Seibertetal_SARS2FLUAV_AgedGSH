...
# Import count table 
count_i <- read.table("/Users/ASVs_counts.tsv", header=T, row.names=1, check.names=F, sep="\t")

# Import taxonomy file 
taxa_i <- as.matrix(read.table("/Users/ASVs_taxonomy_dada_wSpecies.tsv", header=T, row.names=1, check.names=F, sep="\t"))
```
...
saveRDS(object = Phylo.samples_i_filter, file = "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/R_Files/Phylo.samples_i.rds")
```
...
saveRDS(object = sample.rare_i, file = "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/R_Files/RarifiedASVs_i.rds")

sample.rare_i <- readRDS(file = "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/R_Files/RarifiedASVs_i.rds")
...
# FIGURE 5A
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/RarefactionCurve_Intestine_SampleType_LargerFont.pdf",
    width = 6, height = 3) 
...
```{r}
# Import metadata file 
metadata <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/Sars_hamster_metadata.csv", header=T, row.names=1, check.names=F)
...
# Save sample.rare to a file so that i can reload the rarified file 
saveRDS(object = Phylo.rare_i, file = "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/R_Files/Phylo.rare_i.rds")
```

### Figure 5B: Calculate the alpha diversity metrics and plot the graphs in ggplot. 
```{r}
# Import metadata file 2 with sampled ID as a . instead of a -
metadata_2 <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/Sars_hamster_metadata_2.csv", header=T, row.names=1, check.names=F)
...
# Export data 
write.csv(PhlyoRichness_meta_i, "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputFiles/AlphaDiversityIndexes_intestinefeces.csv")
...
write.csv(bray_veg_intestine.melt2.sd, "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputFiles/jaccard_smallIntestine.csv")

# The spreadsheet was edited to include 2 columns: group1 and then the group 2. The matrix was converted into a dataframe. 
bray_veg_intestine.melt2.sd_edited <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputFiles/jaccard_smallIntestine_edited.csv", 
                     header=T, 
                     row.names=1, 
                     check.names=F)
...
# FIGURE S7A
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/BetaDiversity/Boxplot_Jaccard_SI_switched_color.pdf",
    width = 11, height = 8) 
...
write.csv(bray_veg_intestine.melt2.sd, "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputFiles/jaccard_Cecum.csv")

# The spreadsheet was edited to include 2 columns: group1 and then the group 2. The matrix was converted into a dataframe. 
bray_veg_intestine.melt2.sd_edited <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputFiles/jaccard_Cecum_edited.csv", 
                     header=T, 
                     row.names=1, 
                     check.names=F)
# Remove NAs
...
# FIGURE S7B
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/BetaDiversity/Boxplot_Jaccard_Cecum_switched_color.pdf",
    width = 11, height = 8) 
...
write.csv(bray_veg_intestine.melt2.sd, "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputFiles/jaccard_Feces.csv")
...
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/BetaDiversity/Boxplot_Jaccard_Feces_switched_color.pdf",
    width = 16.5, height = 8) 
...
# FIGURE S7C
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/TaxonomicBarplot_phylum_AllSamples_flipped_switched.pdf",
...
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/TaxonomicBarplot_phylum_intestine_NoAg_labels.pdf",
...
```{r}
#Import metadata with new ranking
# Import metadata file 
metadata <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/Sars_hamster_metadata.csv", header=T, row.names=1, check.names=F)
...
write.csv(Taxonomy_i_test, "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/TaxonomyBarplot.csv")
...
# FIGURE S7D
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/TaxonomicBarplot_Genus_Intestine_NoAg_FlippedGroups_switched_white_rev.pdf",
...
# FIGURE 5D
# Plot using ggplot with legend
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Heatmap/RA_Intestine_Heatmap_AllSamples_greaterthan1percent_alphabetical.pdf",
    width = 18, height =6.5, 
...
write.csv(x.all_Mock_IAVSARS,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/ALDeX2_Genus_AllSamples_PreChallenge_ControlvsIAV_Output.csv")

pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/ALDeX2_Genus_AllSamples_PreChallenge_ControlvIAV_MW.pdf",
...
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/ALDeX2_Genus_AllSamples_Prechallenge_ControlvIAV_MW_Edited.pdf",
    width = 3.5, height = 4, # Width and height in inches (3.5 x 4 for single graph) (7 x 4 for double graph)
    bg = "white", )
...
metadata <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/Sars_hamster_metadata.csv")
...
#Write out as csv
write.csv(res_table,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Analysis_Feces_IAVSARS.csv")
...
# FIGURE 8 LEFT
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Genus_AllSamples_MockSARS_switched.pdf",
...
#Write out as csv
write.csv(res_table,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Analysis_Feces_MockSARS.csv")
...
#Write out as csv
write.csv(res_table,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Analysis_Feces_SARSIAV.csv")
...
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Genus_AllSamples_SARSIAV_switched.pdf",
    width = 11, height =5, # Width and height in inches (3.5 x 4 for single graph) (7 x 4 for double graph)
    bg = "white", )
...
# Make the second file (first column being sample names, and the other columns being factors, like "treatment" or "time point" or "date of sequencing" or "species")
# remove unnecessary columns
metadata3 <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/Sars_hamster_metadata_MockPreChallenge.csv")
...
#Write out as csv
write.csv(res_table,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Analysis_Feces_MockPrechallenge.csv")
...
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Genus_AllSamples_MockPreChallenge.pdf",
    width = 11, height =5, # Width and height in inches (3.5 x 4 for single graph) (7 x 4 for double graph)
    bg = "white", )
...
#Write out as csv
write.csv(res_table,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Analysis_Feces_MockPrechallengevFLUAVPreChallenge.csv")
...
#Write out as csv
write.csv(res_table,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Analysis_Feces_PreChallengeIAVSARS.csv")
...
#Write out as csv
write.csv(res_table,"/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Analysis_Feces_PreChallengeSARS.csv")
...
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Deseq2_Genus_AllSamples_PreChallengeSARS.pdf",
    width = 10.5, height =4.7, # Width and height in inches (3.5 x 4 for single graph) (7 x 4 for double graph)
    bg = "white", )
...
write.csv(dc, "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/LefseFile_Feces_PreChallenge.csv")
```

### Figure S9: Producing a heatmap of taxonomy names  
```{r}
Phylo.samples_i_filter_10 <- phyloseq_filter_prevalence(Phylo.samples_i_filter, prev.trh = 0.2, abund.trh = 10, abund.type = "mean", threshold_condition = "AND")
Phylo.samples_i_filter
Phylo.samples_i_filter_10
...
write.csv(Taxonomy_i_edited, "/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Heatmap/hamster_Feces_heatmap_relativeabundances.csv")
...
corr_metadata <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/SARS_hamster_metadata_correlation_test.csv")

#SMALL INTESTINE
corr_metadata <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/SARS_hamster_metadata_correlation_test_SI.csv")

#CECUM
corr_metadata <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/SARS_hamster_metadata_correlation_test_cecum.csv")

#FECES
corr_metadata <- read.csv("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/RawFiles/SARS_hamster_metadata_correlation_test_feces.csv")
...
# Plot using ggplot with legend
pdf("/Users/baseibert/Perez_Lab/Projects/Microbiome/Projects/Hamsters_SARS/R_Files/OutputGraphs/Intestine/TaxonomicAnalysis/Heatmap/Correlation_Heatmap_GenusUnclassifiedFamilies_Feces_ExcludedPreChallenge.pdf",
    width = 9, height =12, 
